    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.patchify = Conv2DBlock(
            inp_img_feat_dim,
            # self.im_channels - 2,       #### 为了3D rope，特征维度必须为6的倍数
            self.fpn_fuse_dim,
        ...
        # self.fpn_fuse_dim = self.im_channels
        self.fpn_fuse_dim = self.im_channels - (self.im_channels % 12)  # 如果 im_chan = 128，这里会算出 120
